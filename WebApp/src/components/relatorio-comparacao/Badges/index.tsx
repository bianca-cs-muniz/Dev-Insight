...
export const Badges = ({ badges, dev1, dev2 }: BadgesProps) => {
  ...
  const BadgeCard = ({ icon: Icon, color, title, subtitle, winnerUsername, backgroundColor }: { icon: LucideIcon, color: string, title: string, subtitle: string, winnerUsername: string, backgroundColor: string }) => {
